...
const services = [
    {name:"Risoterapia y Bienestar Natural", price:8, duration:600},
    {name:"Servicio Express", price:3, duration:300},
    {name:"Horóscopo y Consejos de Vida", price:6, duration:90}
];
...
const microservices = [
    ...
    {category:"😂 Ejercicios rápidos de risa", items:[
        {name:"Risa Relámpago", duration:60, price:3.99},
        {name:"Motívate en un Minuto", duration:60, price:3.99},
        {name:"Respira y Sonríe", duration:60, price:3.99},
        {name:"Confianza Express", duration:60, price:5.99},
    ...
    {category:"🔮 Horóscopos y consejos breves", items:[
        ...
        {name:"Consejo del Día", duration:60, price:5.99},
        {name:"Amor Instantáneo", duration:60, price:3.99},
        {name:"Abundancia en 2 Minutos", duration:60, price:5.99},
        {name:"Mensaje de tu Estrella", duration:60, price:3.99}
    ]},
    {category:"💚 Hábitos saludables instantáneos", items:[
        {name:"Mini Diagnóstico de Hábitos", duration:60, price:3.99},
        {name:"Ejercicio TVid Express", duration:60, price:3.99},
        {name:"Prevención en un Minuto", duration:60, price:5.99},
        {name:"Reto 3 Días Express", duration:60, price:5.99},
        {name:"Tracker de Bienestar Diario", duration:60, price:3.99}
    ]},
    {category:"🔥 Recetas verdes express", items:[
        {name:"Receta Verde Express", duration:60, price:3.99},
        {name:"Té Relajante Rápido", duration:60, price:5.99},
        {name:"Batido Creativo", duration:60, price:3.99},
        {name:"Infusión para Claridad Mental", duration:60, price:5.99},
        {name:"Mini Detox Express", duration:60, price:3.99}
    ]}
];
